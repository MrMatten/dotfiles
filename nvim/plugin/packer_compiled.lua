...
_G.packer_plugins = {
  ...
  neotest = {
    after = { "neotest-python", "neotest-plenary", "neotest-go", "neotest-jest", "neotest-vim-test", "FixCursorHold.nvim" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-npm", "cmp-nvim-lsp", "cmp-path", "cmp_luasnip", "cmp-buffer", "LuaSnip" },
  ...
  ["oceanic-next"] = {
    config = { "\27LJ\2\n?\0\0\3\0\4\0\0066\0\0\0009\0\1\0009\0\2\0'\2\3\0B\0\2\1K\0\1\0\16OceanicNext\16colorscheme\bcmd\bvim\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n?\0\0\3\0\4\0\0066\0\0\0009\0\1\0009\0\2\0'\2\3\0B\0\2\1K\0\1\0\16OceanicNext\16colorscheme\bcmd\bvim\0", "config", "oceanic-next")
